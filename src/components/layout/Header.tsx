...
import {RiAddLine, RiArrowDownSFill, RiMenuLine} from '@remixicon/react'
...
const Header: React.FC<HeaderProps> = ({sidebarOpen, setSidebarOpen}) => {
  ...
  return (
    <header className="w-full bg-white p-1 sticky top-0 z-40">
      <div
        className=" px-4 py-2 tablet:py-3 bg-[#181B1E] backdrop-blur-xl flex justify-center items-center overflow-hidden">
        {/* Background blur gradient */}
        <div className="w-full tablet:w-[1024px] desktop:w-full h-20 left-0 top-0 absolute overflow-hidden">
          <div
            className="w-60 h-20 left-20 tablet:left-[402px] desktop:left-[712px] top-[-69px] absolute bg-gradient-to-bl from-amber-300 to-emerald-500 rounded-full blur-[130px]"/>
        </div>
        ...
        <div className="max-tablet:flex-1 tablet:w-full flex justify-between items-center relative z-10">
          ...
          <div className="flex justify-start items-center">
            ...
            <div className="flex justify-start items-center gap-6 overflow-hidden">
              <div
                className="w-36 tablet:w-40 desktop:w-40 h-8 tablet:h-9 desktop:h-9 flex justify-start items-center gap-2 tablet:gap-2.5 desktop:gap-2.5">
          ...
          >
            ...
            >
              ...
              <span
                className="text-center justify-center text-white text-sm font-semibold font-inter-tight leading-normal tracking-wide">
